            ...
            children.forEach((child) => {
                ...
                Array.from(childChildren).forEach((element) =>{
                    ...
                    const transitionSlider= ()=>{
                        ...
                        classes.remove('ease-out');
                        classes.remove('-translate-x-64');

                        firstElement.parentElement.appendChild(firstElement);
                    }
                    element.addEventListener('transitionend', transitionSlider)
                })
            });
          }
    }
            ...
            children.forEach((child) => {
                ...
                Array.from(childChildren).forEach((element) =>{
                    ...
                    const transitionSlider= ()=>{
                        ...
                        lastElement.parentElement.insertBefore(lastElement, slideshow.current.firstChild);
                    }
                    element.addEventListener('transitionend', transitionSlider)
                })
            });
